package JAVA.SHASHCODE.LECTURE235;

public class Number_of_operations_to_make_network_connected_in_graph {
    public int makeConnected(int n, int[][] connections) {
        ...
        // for connecting n nodes, we require a minimum of n-1 edges so minimum wire requires = (n-1) - (wires-used)
